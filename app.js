...
const IMAGE_SLOTS = [
  ...
  ["quads","فخذ أمامي"],["adductors","فخذ داخلي"],["hamstrings","فخذ خلفي"],
...
const EX = [
  ...
  {id:"rdl",name:"رفعة رومانية بالدمبل",group:"hams",muscle:"hamstrings",env:["gym","home"],level:1,risk:["lowerback","knee"],tip:"ادفع وركك للخلف وحافظ على ظهرك مستقيماً تماماً.",type:"compound",pattern:"legs"},
  ...
  {id:"goodmorning",name:"تمرين صباح الخير",group:"hams",muscle:"hamstrings",env:["gym","home"],level:1,risk:["lowerback"],tip:"ادفعي الورك للخلف بظهر مستقيم لاستهداف الفخذ الخلفي.",type:"compound",pattern:"legs"},
  ...
  {id:"singleleg",name:"رفعة رومانية بساق واحدة",group:"hams",muscle:"hamstrings",env:["home","bodyweight","gym"],level:1,risk:["lowerback"],tip:"وازني على ساق واحدة ومدّي الأخرى خلفك مع ميل الجذع.",type:"compound",pattern:"legs"},
  ...
  /* ===== فخذ داخلي (Adductors) ===== */
  {id:"hipadduction",name:"جهاز ضمّ الأرجل",group:"adductors",muscle:"adductors",env:["gym"],level:1,risk:[],tip:"اضغطي ساقيك للداخل ببطء واعصري الفخذ الداخلي.",type:"isolation",pattern:"legs"},
  {id:"sumosquat2",name:"سكوات سومو عميق",group:"adductors",muscle:"adductors",env:["gym","home","bodyweight"],level:1,risk:["knee"],tip:"باعدي قدميك ووجّهي أصابعك للخارج وانزلي عميقاً.",type:"compound",pattern:"legs"},
  {id:"sidelyingraise",name:"رفع الساق جانبياً (مستلقية)",group:"adductors",muscle:"adductors",env:["home","bodyweight"],level:1,risk:[],tip:"استلقي على جنبك وارفعي الساق السفلية للأعلى ببطء.",type:"isolation",pattern:"legs"},
  {id:"copenhagen",name:"تمرين كوبنهاجن",group:"adductors",muscle:"adductors",env:["bodyweight","home"],level:3,risk:[],tip:"ارفعي جسمك على مقعد بساق واحدة مع شدّ الفخذ الداخلي.",type:"isolation",pattern:"legs"},
  {id:"plie",name:"سكوات بليه بالدمبل",group:"adductors",muscle:"adductors",env:["gym","home"],level:1,risk:["knee"],tip:"قفي بوضع باليه وانزلي مستقيمة مع عصر الفخذ الداخلي.",type:"compound",pattern:"legs"},
  {id:"cableadduction",name:"ضمّ الورك بالكيبل",group:"adductors",muscle:"adductors",env:["gym"],level:2,risk:[],tip:"اسحبي ساقك للداخل عبر جسمك ضد المقاومة.",type:"isolation",pattern:"legs"},
  {id:"bandadduction",name:"ضمّ الأرجل بالشريط",group:"adductors",muscle:"adductors",env:["home"],level:1,risk:[],tip:"ثبّتي الشريط جانباً واسحبي ساقك للداخل ببطء.",type:"isolation",pattern:"legs"},
  ...
  {id:"stiffdl",name:"رفعة ساق مستقيمة",group:"hams",muscle:"hamstrings",env:["gym","home"],level:1,risk:["lowerback"],tip:"حافظي على ساقيك شبه مستقيمتين وادفعي وركك للخلف.",type:"compound",pattern:"legs"},
...
const FOCUS = {
  lower:    {name:"تركيز سفلي", ico:"🍑", sub:"أرجل ومؤخرة", muscles:["quads","hams","glutes","adductors","calves"]},
...
const COVERAGE_MUSCLES = ["chest","back","shoulders","quads","hams","glutes","adductors","biceps","triceps","calves","abs"];
const MIN_WEEKLY_APPEARANCE = { // أقل عدد مرات يجب أن تظهر فيها العضلة أسبوعياً
  ...
  adductors:1, biceps:1, triceps:1, calves:1, abs:1
};

/* الحد الأدنى الصارم للجلسات (المجموعات) الأسبوعية لكل عضلة — لا ينزل تحته أبداً */
const MIN_WEEKLY_SETS = { big:10, small:8 };
function minSetsFor(group){ return BIG_GROUPS.includes(group) ? MIN_WEEKLY_SETS.big : MIN_WEEKLY_SETS.small; }
...
const SPLIT_SYSTEMS = {
  ppl:{
    ...
    days:{
      ...
      2:[
        ...
        ["back","biceps","quads","hams","glutes","adductors","calves"]
      ],
      // ثلاثة: دفع / سحب / أرجل — كل عضلة مرة (مثالي للمبتدئة)
      3:[
        ["chest","shoulders","triceps","abs"],
        ["back","biceps","abs"],
        ["quads","hams","glutes","adductors","calves"]
      ],
      ...
      5:[
        ...
        ["quads","hams","glutes","adductors","calves"],
        ["chest","shoulders","triceps","abs"],
        ["back","biceps","quads","glutes","adductors"]
      ]
    }
  },
  ul:{
    ...
    days:{
      ...
      2:[
        ["chest","back","shoulders","biceps","triceps","abs"],
        ["quads","hams","glutes","adductors","calves","abs"]
      ],
      3:[
        ["chest","back","shoulders","biceps","triceps","abs"],
        ["quads","hams","glutes","adductors","calves","abs"],
  ...
  fullbody:{
    ...
    days:{
      ...
      2:[
        ["chest","back","quads","hams","glutes","adductors","shoulders","biceps","abs"],
        ["chest","back","quads","hams","glutes","adductors","triceps","calves","abs"]
      ],
      3:[
        ["chest","back","quads","glutes","adductors","shoulders","biceps","abs"],
        ["chest","back","hams","glutes","adductors","triceps","calves"],
      ...
      4:[
        ...
        ["chest","back","hams","glutes","adductors","triceps","calves"],
        ["chest","back","quads","glutes","adductors","shoulders","biceps","abs"],
        ["chest","back","hams","glutes","adductors","triceps","calves","abs"]
      ],
      5:[
        ["chest","back","quads","glutes","adductors","shoulders","biceps","abs"],
        ["chest","back","hams","glutes","adductors","triceps","calves"],
        ["chest","back","quads","glutes","adductors","shoulders","biceps"],
        ["chest","back","hams","glutes","adductors","triceps","calves","abs"],
        ["chest","back","quads","hams","glutes","adductors","shoulders","biceps","abs"]
      ]
    }
...
function generate(){
  ...
  const plan = split.map((groups, dayIdx)=>{
    ...
    // الكبيرة: تمرينان — الصغيرة: تمرين — والمركّز عليها تحصل على +2 إضافي
    const minQuota = groups.map(g=>{
      let q = BIG_GROUPS.includes(g)?2:1;
      if(isFocus(g)) q += 2;   // التركيز يرفع الحد الأدنى للعضلة المختارة بقوة
      return q;
    });
    ...
    // الوزن في توزيع الفائض: الكبيرة 2، الصغيرة 1، والمركّز عليها تُضاعف بقوة
    const weights = groups.map(g=>{
      let w = BIG_GROUPS.includes(g)?2:1;
      if(isFocus(g)) w += 3;   // أولوية أعلى للفائض لصالح منطقة التركيز
      return w;
    });
  ...
  // ===== طبقة الحد الأدنى للجلسات الأسبوعية =====
  // تضمن أن كل عضلة كبيرة ≥10 جلسات وكل صغيرة ≥8 جلسات أسبوعياً
  ensureMinimumVolume(plan, danger, used);
...
/* تضمن الحد الأدنى للجلسات الأسبوعية: كبيرة ≥10، صغيرة ≥8.
   الجلسات = عدد تمارين العضلة أسبوعياً × المجموعات لكل تمرين.
   تضيف تمارين للعضلات الناقصة في الأيام التي تظهر فيها. */
function ensureMinimumVolume(plan, danger, used){
  const L=loadParams();
  const setsPer = parseInt(L.sets,10)||3;

  // نحسب عدد تمارين كل عضلة أسبوعياً
  const exCount = () => {
    const c={};
    plan.forEach(d=>d.exercises.forEach(e=>{ c[e.group]=(c[e.group]||0)+1; }));
    return c;
  };
  ...
  COVERAGE_MUSCLES.forEach(muscle=>{
    ...
    let guard=0;
    while((exCount()[muscle]||0) < needExercises && guard<10){
      guard++;
      // نبحث عن تمرين متاح لم يُستخدم بعد
      ...
      if(!pool.length) break; // لا يوجد تمرين متاح — نحترم الاستبعاد ولا نكسره

      // ترتيب الاختيار: المفضّل، ثم المعدة حسب البيئة، ثم مركّب، ثم غير مستخدم
      const isBand = e => e.id.startsWith("band")||e.name.includes("شريط")||e.name.includes("باند");
      const isMachine = e => e.name.includes("جهاز")||e.name.includes("كيبل")||e.name.includes("ماكينة")||e.name.includes("سميث");
      const equipRank = e => {
        if(S.env==="gym") return isBand(e)?2:isMachine(e)?0:1;
        if(S.env==="home") return isBand(e)?2:0;
        return 0;
      };
      pool.sort((a,b)=>{
        const fa=S.fav.has(a.id)?0:1, fb=S.fav.has(b.id)?0:1;
      ...
      const pick = pool.find(e=>!used.has(e.id));
      if(!pick) break; // كل التمارين المتاحة مستخدمة بالفعل — لا نكرّر

      // نضيفه لأنسب يوم: يوم يحتوي نفس العضلة (لتكثيفها)، وإلا الأقل ازدحاماً
      const dayScores=plan.map((d,idx)=>{
        const hasMuscle=d.exercises.some(e=>e.group===muscle)?0:1;
        return {idx, hasMuscle, count:d.exercises.length};
      }).sort((a,b)=> a.hasMuscle-b.hasMuscle || a.count-b.count);
      ...
      if(gOrder[muscle]===undefined) gOrder[muscle]=BIG_GROUPS.includes(muscle)?50:150;
